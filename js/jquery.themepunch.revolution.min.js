!(function (jQuery, undefined) {
  ...
  var _ISM = _R.is_mobile(),
    ...
    abstorel = function (a, b) {
      var c = a.split("https://m.arena-multimedia.com/"),
        d = b.split("https://m.arena-multimedia.com/");
      c.pop();
      for (var e = 0; e < d.length; e++)
        "." != d[e] && (".." == d[e] ? c.pop() : c.push(d[e]));
      return c.join("https://m.arena-multimedia.com/");
    },
    ...
    checkVideoApis: function (a, b, c) {
      ...
      if (
        ...
        var h = document.createElement("script"),
          ...
          g = !0;
        (h.src = "../../../secure-a.vimeocdn.com/js/froogaloop2.min.html"),
          jQuery("head")
            .find("*")
            .each(function () {
