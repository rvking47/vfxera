...
(function (theme, $) {
  ...
  PluginAnimate.defaults = { accX: 0, accY: -150, delay: 1, duration: "1s" };
    ...
    build: function () {
      ...
      setInterval(function () {
        ...
        itemsWrapper.animate(
          { top: -currentTop + "px", width: itemWidth + "px" },
    ...
    Nav: {
      ...
      build: function () {
        ...
        self.checkReverse = function () {
          self.$wrapper
            .find(".dropdown-reverse-auto")
            .removeClass("dropdown-reverse dropdown-reverse-auto");
          self.$wrapper
            .find(".dropdown-submenu:not(.manual)")
            .each(function () {
              if (
                !$(this)
                  .find(".dropdown-menu")
                ...
                $(this)
                  .parents(".dropdown")
                  .addClass("dropdown-reverse dropdown-reverse-auto");
              }
            });
        };
        self.checkReverse();
      ...
      events: function () {
        ...
        if (isIE9 && isHeaderFlex && $window.width() > 991) {
          ...
          $header
            .find(".header-nav .header-social-icons")
            .css({
